        ...
        <>
            <MobileContainer>
                <div className="slogan-container w-full min-h-screen  flex flex-col  items-center relative  " style={{ backgroundImage: "url('/images/backimg.jpeg')", backgroundSize: "cover" }}>
                    ...
                    <MdArrowBackIosNew  className='text-black text-xl cursor-pointer absolute top-8 left-5   ' onClick={() => router.back()} />
                    ...
                    <div className='w-full p-4 '>
                        <div className='w-[100%] h-auto bg-white rounded-t-lg flex gap-4 border border-black  p-6'>
                            <div className='flex items-center w-20'>
                                <img className='w-auto h-auto' src="/youth congress.png" alt=""/>
                            </div>
...
<img  onClick={() => window.open("https://www.instagram.com/indianyouthcongress/")} src="/icons-icons-facebook-facebook-icon-png-and-psd-instagram-facebook-twitter-logo-115628509484rvrbar9nl 4.png" alt="" />    
                        ...
                        <div className='w-[100%] h-auto bg-white flex gap-4 border border-black  p-6'>
                            <div className='flex items-center w-20 '>
                                <img className='h-20 w-24 rounded-full' src="/Kerala-students-union-flag 1.png" alt="" />
                            </div>
<div className='flex flex-col gap-4'>
...
<img  onClick={() => window.open("https://www.instagram.com/explore/tags/keralacongress/")} src="/icons-icons-facebook-facebook-icon-png-and-psd-instagram-facebook-twitter-logo-115628509484rvrbar9nl 4.png" alt="" />    
                        ...
                        <div className='w-[100%] h-auto bg-white  flex gap-4 border border-black  p-6'>
                            <div className='flex items-center w-20'>
                                <img className='w-auto h-auto' src="/Congress_seva.png" alt="" />
                            </div>
<div className='flex flex-col gap-4'>
...
<img  onClick={() => window.open("https://www.instagram.com/indianyouthcongress/")} src="/icons-icons-facebook-facebook-icon-png-and-psd-instagram-facebook-twitter-logo-115628509484rvrbar9nl 4.png" alt="" />    
                        ...
                        <div className='w-[100%] h-auto bg-white  flex gap-4 border border-black  p-6'>
                            <div className='flex items-center w-20'>
                                <img className='w-auto h-auto' src="/Indian_National_Congress_hand.png" alt="" />
                            </div>
<div className='flex flex-col gap-4'>
