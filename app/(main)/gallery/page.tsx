...
function Gallery() {
    ...
    return (
        <>
            <MobileContainer>
                <div className="gallery-container w-full  flex flex-col justify-start items-center relative" style={{ backgroundImage: "url('images/backimg.jpeg')", backgroundSize: "cover" }}>
